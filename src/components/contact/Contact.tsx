  ...
  return (
    <section id="contact" className="relative py-28">
      <div className="relative z-10 max-w-screen-xl mx-auto text-gray-600 sm:px-4 md:px-8">
        ...
        <div className="mt-12 mx-auto px-4 p-8 bg-gray-900 sm:max-w-lg sm:px-8 sm:rounded-xl bg-opacity-50">
      ...
      <div
        className="absolute inset-20 blur-[118px] max-w-lg h-[800px] mx-auto sm:max-w-3xl sm:h-[300px]"
        style={{
          background:
