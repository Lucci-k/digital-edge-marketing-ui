...
const Footer = () => {
  ...
  const footerNavs = [
    ...
    },
    {
      label: 'About',
      items: [
        { href: '/terms-and-conditions', name: 'Terms' },
  ...
  return (
    <footer className="text-gray-500 px-4 py-5 w-full max-w-screen-xl mx-auto items-center md:px-8">
      <div className="gap-6 justify-between md:flex">
        <div className="flex-1">
          <div className="max-w-sm">
            <Image alt="logo" src={digitalEdge} width={250} height={118} />
            <p className="leading-relaxed mt-2 text-[15px]">
              Delivering innovative marketing solutions to transform your business. We offer strategic campaigns, data-driven insights, creative content, and advanced security. Elevate your brand and achieve your goals with our expert, tailored marketing.
            </p>
          </div>
          <form onSubmit={handleSubmit}>
            ...
            <div className="max-w-sm flex items-center rounded-md p-1">
              ...
              />
              <button className="ml-5 px-3 py-2 rounded-lg text-white bg-indigo-600 outline-none shadow-md hover:bg-indigo-700 sm:px-5">
                Subscribe
              </button>
            </div>
          </form>
        ...
        <div className="flex-1 mt-10 space-y-6 justify-between sm:flex md:space-y-0 md:mt-0">
          {footerNavs.map((item, idx) => (
            <ul className="space-y-4 pt-11" key={idx}>
              <h4 className="text-gray-700 font-medium">{item.label}</h4>
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">&copy; {year} Digital Edge All rights reserved.</div>
